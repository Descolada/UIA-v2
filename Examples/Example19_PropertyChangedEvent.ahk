...
handler := UIA.CreateEventHandler(PropertyChangedEventHandler, "PropertyChanged")
UIA.AddPropertyChangedEventHandler(explorerEl, UIA.Property.Name,handler) ; Multiple properties can be specified in an array
